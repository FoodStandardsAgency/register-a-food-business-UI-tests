...
Establishment address simple contact details section validation
    ...
    Scenario: happy path without optional field
        ...
        And I open the url "purbeck/establishment-contact-details"
    ...
    Scenario: invalid phone number
        Given I open the url "/cleansession"
        Given I open the url "purbeck/establishment-contact-details"
    ...
    Scenario: happy path using operator details
        Given I open the url "/cleansession"
        And I go to a special QA page at url "/qa/purbeck/establishment-contact-details" with injected "declaration" data
