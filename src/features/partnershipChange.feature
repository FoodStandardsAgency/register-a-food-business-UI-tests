...
Feature: As Samantha I need to be able to change the partnership details
  ...
  Scenario: Change details within Partnership path
    ...
    When I click on the element "commonElements.continuetonextpageButton"
    ...
    And I expect that element "registrationSummary.partnerOne" contains the text "one change,Two,Three"
