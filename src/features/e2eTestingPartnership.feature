...
Feature: Testing user journey for partnership
    ...
    Scenario: Happy path
        ...
        And I expect that element "mainPartnershipContact.partnerOne" contains the text "partner one"
        And I expect that element "mainPartnershipContact.partnerTwo" contains the text "partner two"
        And I expect that element "mainPartnershipContact.partnerThree" contains the text "partner three"
        And I expect that element "mainPartnershipContact.partnerFour" contains the text "partner four"
        And I expect that element "mainPartnershipContact.partnerFive" contains the text "partner five"
    ...
    Scenario: happy path
        ...
        When I click on the element "commonElements.continueButton"
        And I click on the element "mainPartnershipContact.partnerTwo"
        And I click on the element "commonElements.continueButton"
