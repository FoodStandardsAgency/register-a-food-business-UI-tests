...
Feature: Summary Page
  ...
  Scenario: navigate to declaration page
    Given I go to a special QA page at url "/qa/purbeck/registration-summary" with injected "registration-summary" data
  ...
  Scenario: missing data not displayed
    ...
    And I open the url "purbeck/establishment-trading-name"
    ...
    When I open the url "purbeck/registration-summary"
