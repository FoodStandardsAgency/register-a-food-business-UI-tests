...
Feature: Testing user journey for Jamie
    ...
    Scenario: happy path
        ...
        When I set "PE12 8JA" to the inputfield "estabAddress.estabPostcodeFind" 
        When I click on the element "estabAddress.button"
        Then I expect the url to contain "la-established"
        And I expect that element "estabAddress.postcodeDisplay" contains the text "You are registering with South Holland District Council" 
        When I click on the element "estabAddress.button"
