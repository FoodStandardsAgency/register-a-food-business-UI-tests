Feature: Landing Page
    ...
    Scenario: Editing the name of a local authority
        ...
        When I click on the element "landingPage.continueButton"
    ...
    Scenario:Deleting a local authority
        ...
        When I click on the element "landingPage.button"
        Then I expect the url to contain "la"
        And I set "4094" to the inputfield "landingPage.searchField"
        ...
        And I click on the element "landingPage.continueButton"
