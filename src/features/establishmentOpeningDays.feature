@registration_role_SDB-52
Feature: Establishment opening days SDB-52

    Establihsment opening days section validation

    @change_registration_role_SDB-52
    Scenario: able to change over all opening days
        #Given I open the url "/cleansession"
        Given I open the url "mid-and-east-antrim/opening-days-start"
    ...
    Scenario: selects one option and then deselects it
        ...
        Then I expect that checkbox "openingDaysSome.saturday" is not checked

    @opening_days_somes_direct_import_and_none_forward_then_back_SDB-124
    Scenario: selects one option and then deselects it
        Given I open the url "/cleansession"
        And I open the url "mid-and-east-antrim/opening-days-some"
        When I click on the element "openingDaysSome.monday"
        ...
        Then I expect that checkbox "openingDaysSome.monday" is checked
        And I expect that checkbox "openingDaysSome.tuesday" is checked
