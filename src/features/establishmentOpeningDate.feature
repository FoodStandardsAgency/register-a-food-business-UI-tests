...
Establishment opening status and date
    ...
    Scenario: proactive trading date happy path
        ...
        And I open the url "https://register-a-food-business-dev.azurewebsites.net/establishment-opening-status"
        When I click on the element "estabOpeningDate.notTrading"
        And I click on the element "estabOpeningDate.button"
        Then I expect that the url is "https://register-a-food-business-dev.azurewebsites.net/establishment-opening-date-proactive"
        ...
        And I click on the element "estabOpeningDate.button"
        And I expect that the url is not "https://register-a-food-business-dev.azurewebsites.net/establishment-opening-date-proactive"
    ...
    Scenario: proactive trading date no dates
        ...
        Then I expect that the url is "https://register-a-food-business-dev.azurewebsites.net/establishment-opening-date-proactive"
        And I click on the element "estabOpeningDate.button"
        And I expect that the url is "https://register-a-food-business-dev.azurewebsites.net/establishment-opening-date-proactive"
    ...
    Scenario: retroactive trading date happy path
        ...
        And I set "1999" to the inputfield "estabOpeningDate.year"
        And I click on the element "estabOpeningDate.button"
        And I expect that the url is not "https://register-a-food-business-dev.azurewebsites.net/establishment-opening-date-retroactive"
    ...
    Scenario: retroactive trading date no dates
        ...
        Then I expect that the url is "https://register-a-food-business-dev.azurewebsites.net/establishment-opening-date-retroactive"
        And I click on the element "estabOpeningDate.button"
        And I expect that the url is "https://register-a-food-business-dev.azurewebsites.net/establishment-opening-date-retroactive"
        Then I expect that element "estabOpeningDate.error" contains the text "Not a valid opening date"
